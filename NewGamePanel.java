...
{
   private static ImageIcon BACKGROUND = new ImageIcon("Untitled with changing colors.png");
      ...
      public void run()
      {
         while(true)
         {
            while(leftPressed == true)
            {
               ...
               if(player.inObstacle(obstacles, playerTempX, player.getY()) == false && playerTempX >= 0)
                  player.moveLeft();
               repaint();
